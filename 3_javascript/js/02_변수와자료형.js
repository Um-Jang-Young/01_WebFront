...
console.log(foo1); // 123, 전역변수이기 떄문에 (블록과 관계없음) 접근가능
console.log(foo2); // 456, 전역변수이기 떄문에 (블록과 관계없음) 접근가능
// console.log(num1); // ReferenceError: num1 is not defined
// console.log(num2); // ReferenceError: num1 is not defined
// -> 둘다 블록레벨 스코프 이기 떄문에 블록 밖에서 접근할 수 없음
...
// -> 가능 .. 왜? 함수레벨 스코프인 var는 불록을 무시하기 때문에
...
// 즉, 함수 블록 안에서 선언된 var 벼 ㄴ수는 함수 안에서만 사용 가능
// (== 함수 외부에서 사용 불가)
...
console.log("isTrue : ", true, typeof isTrue);
console.log("isFalse : ", false, typeof isFalse);
